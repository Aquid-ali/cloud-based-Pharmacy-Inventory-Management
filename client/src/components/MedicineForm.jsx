  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 sm:p-8 space-y-8" noValidate>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 placeholder:text-slate-400 ${
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 placeholder:text-slate-400"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              value={form.category}
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 text-slate-700 bg-white cursor-pointer ${
      ...
      <div className="pt-6 border-t border-slate-100">
        <h3 className="text-sm font-bold text-slate-800 mb-1">Product Information</h3>
        <p className="text-xs text-slate-400 mb-4">Batch, dates, stock, and pricing.</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div>
            <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-2">
              Batch Number *
            ...
            <input
              ...
              className={`w-full px-4 py-3 border rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 placeholder:text-slate-400 font-mono ${
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-4 py-3 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 text-slate-700"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full px-4 py-3 border rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 text-slate-700 ${
      ...
      <div className="pt-6 border-t border-slate-100">
        <h3 className="text-sm font-bold text-slate-800 mb-1">Additional Information</h3>
        <p className="text-xs text-slate-400 mb-4">Optional notes shown on the medicine's detail page.</p>
        <div>
          <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-2">
            Description
          </label>
          <textarea
            ...
            className="w-full px-4 py-3 border border-slate-200 rounded-2xl text-sm focus:outline-none focus:border-brandPrimary focus:ring-4 focus:ring-brandPrimary/10 placeholder:text-slate-400 resize-none"
          />
        </div>
      </div>
      ...
      <div className="pt-4 flex justify-end">
        <button
          type="submit"
          disabled={submitting}
          className="bg-brandPrimary hover:bg-brandPrimaryHover disabled:opacity-60 text-white font-medium py-3 px-8 rounded-2xl text-sm transition-all shadow-lg shadow-brandPrimary/20"
        >
