...
const SalesHistory = () => {
  ...
  return (
    <ListPage
      ...
      stats={[
        { icon: FiDollarSign, label: "Today's Sales", value: formatCurrency(stats?.todayRevenue), bgTint: 'bg-brandPrimary/10', iconColor: 'text-brandPrimary', borderColor: 'border-brandPrimary/20' },
