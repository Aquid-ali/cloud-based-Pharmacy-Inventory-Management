...
const ReturnsRefunds = () => (
  <ListPage
    ...
    stats={[
      { icon: FiRotateCcw, label: 'Total Returns', value: returnsData.length, bgTint: 'bg-brandPrimary/10', iconColor: 'text-brandPrimary', borderColor: 'border-brandPrimary/20' },
