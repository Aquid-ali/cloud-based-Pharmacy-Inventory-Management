...
const Quotations = () => (
  <ListPage
    ...
    stats={[
      { icon: FiFileText, label: 'Total Quotes', value: quotationsData.length, bgTint: 'bg-brandPrimary/10', iconColor: 'text-brandPrimary', borderColor: 'border-brandPrimary/20' },
