...
const LoyaltyProgram = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
      ...
      <StatCard icon={FiTrendingUp} label="Points Issued" value="12,450" bgTint="bg-brandPrimary/10" iconColor="text-brandPrimary" borderColor="border-brandPrimary/20" />
    </div>
    ...
    <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6">
      <h3 className="font-display font-bold text-slate-800 mb-4">Program Settings</h3>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label className="block text-xs font-medium text-slate-500 mb-1.5">Points per ₹100 spent</label>
          <input type="number" defaultValue={10} className="w-full px-4 py-2.5 rounded-2xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-brandPrimary/20 focus:border-brandPrimary" />
        </div>
        <div>
          <label className="block text-xs font-medium text-slate-500 mb-1.5">Points expiry (months)</label>
          <input type="number" defaultValue={12} className="w-full px-4 py-2.5 rounded-2xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-brandPrimary/20 focus:border-brandPrimary" />
        </div>
      </div>
      <button className="mt-4 px-5 py-2.5 bg-brandPrimary text-white rounded-2xl text-sm font-semibold hover:bg-brandPrimaryHover transition-colors">
        Save Settings
      </button>
    </div>
  </div>
