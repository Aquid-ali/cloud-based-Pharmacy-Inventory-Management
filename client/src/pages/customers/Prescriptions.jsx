...
const Prescriptions = () => (
  <ListPage
    ...
    stats={[
      { icon: FiFileText, label: 'Total Prescriptions', value: prescriptionsData.length, bgTint: 'bg-brandPrimary/10', iconColor: 'text-brandPrimary', borderColor: 'border-brandPrimary/20' },
