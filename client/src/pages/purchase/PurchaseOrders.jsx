...
const PurchaseOrders = () => (
  <ListPage
    ...
    stats={[
      { icon: FiClipboard, label: 'Total Orders', value: purchaseOrdersData.length, bgTint: 'bg-brandPrimary/10', iconColor: 'text-brandPrimary', borderColor: 'border-brandPrimary/20' },
