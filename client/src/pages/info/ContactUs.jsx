...
const ContactUs = () => (
  ...
  >
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 flex items-start gap-4">
      <div className="w-10 h-10 shrink-0 rounded-xl bg-primary-50 text-brandPrimary flex items-center justify-center">
        <FiMapPin size={18} />
      </div>
      <div>
        ...
        <Link to="/shop/stores" className="inline-block mt-3 text-xs font-semibold text-brandPrimary hover:text-brandPrimaryHover">
          Browse Pharmacies →
        </Link>
      </div>
    </div>
    ...
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 flex items-start gap-4">
      ...
      <div>
        ...
        <Link to="/faqs" className="inline-block mt-3 text-xs font-semibold text-brandPrimary hover:text-brandPrimaryHover">
          View FAQs →
        </Link>
      </div>
    </div>
