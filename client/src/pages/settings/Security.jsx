  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        <StatCard icon={FiLock} label="2FA Status" value="Enabled" bgTint="bg-brandPrimary/10" iconColor="text-brandPrimary" borderColor="border-brandPrimary/20" />
      ...
      <div className="bg-white rounded-3xl border border-slate-200/80 shadow-sm p-6 space-y-5">
        <h3 className="font-display font-bold text-slate-800">Security Settings</h3>
        ...
        <div className="space-y-4">
          {[
            ...
            <label key={setting.label} className="flex items-start gap-3 cursor-pointer p-3 rounded-2xl hover:bg-slate-50 transition-colors">
              <input type="checkbox" defaultChecked={setting.defaultChecked} className="w-4 h-4 mt-0.5 rounded accent-brandPrimary" />
              <div>
        ...
        <div className="pt-2 border-t border-slate-100">
          ...
          <select defaultValue="8" className="w-full sm:w-48 px-4 py-2.5 rounded-2xl border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-brandPrimary/20 focus:border-brandPrimary">
        ...
        <button onClick={handleSave} className="px-5 py-2.5 bg-brandPrimary text-white rounded-2xl text-sm font-semibold hover:bg-brandPrimaryHover transition-colors">
